...
const Cart = () => {
  ...
  const handleApplyPromo = () => {
    if (!promoCode.trim()) {
      toast.error("Please enter any promo code first");
    } else {
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="w-full p-2 border border-black/20 rounded-md text-sm focus:ring-1 focus:ring-black outline-none"
                        placeholder="Enter promo"
                      />
                      <button
                        onClick={handleApplyPromo}
                        className="border border-black px-3 py-1 rounded-md text-sm hover:bg-black hover:text-white transition-all cursor-pointer active:scale-95"
                      >
                        Apply
                      </button>
                    </div>
