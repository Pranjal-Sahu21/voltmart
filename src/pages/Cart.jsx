...
import notSignedIn from "../assets/Cartshop.json";
      ...
      <SignedOut>
        <div className="min-h-screen flex flex-col items-center justify-center px-6 py-14 text-center bg-linear-to-b from-gray-50 to-gray-100">
          ...
          <motion.div
            ...
            className="rounded-2xl p-6 sm:p-10 w-full max-w-md -mt-20"
          >
            ...
            <p className="text-gray-600 text-base sm:text-lg mb-8 leading-relaxed">
              Please sign in to view your cart, manage delivery details, and
              place orders.
            </p>
            ...
            <SignInButton>
              <motion.button
                ...
                className="bg-black text-white px-6 py-3 rounded-full cursor-pointer text-base font-medium shadow-lg hover:bg-gray-800 transition-all duration-200"
              >
                Sign In
              </motion.button>
            </SignInButton>
